Collecting workspace informationLooking at your repository structure and content, I need to create a README.md for an Azure Batch Account module following the Azure Verified Module (AVM) format. I'll generate this content based on the standard patterns I see in your existing files.

Here's the updated README.md content for your terraform-azurerm-avm-res-batch-batchaccount module:
...
Description: The name of the batch account resource.
...
Description: A map of diagnostic settings to create on the Batch Account. The map key is deliberately arbitrary to avoid issues where map keys maybe unknown at plan time.
...
### <a name="input_enable_telemetry"></a> enable\_telemetry
...
### <a name="input_managed_identities"></a> managed\_identities
...
### <a name="input_private_endpoints"></a> private\_endpoints
...
### <a name="input_role_assignments"></a> role\_assignments
...
### <a name="input_pool_allocation_mode"></a> pool\_allocation\_mode
...
### <a name="input_public_network_access_enabled"></a> public\_network\_access\_enabled

Description: Whether public network access is enabled for the Batch Account. Defaults to true.
...
Description: The ID of the Storage Account to use for the Batch Account. Required if pool_allocation_mode is set to BatchService.

Type: `string`

Default: `null`

### <a name="input_allowed_authentication_modes"></a> allowed\_authentication\_modes

Description: List of allowed authentication modes for the Batch Account. Possible values are AAD, SharedKey, or TaskAuthenticationToken.

Type: `set(string)`

Default: `["AAD", "SharedKey", "TaskAuthenticationToken"]`

### <a name="input_encryption"></a> encryption

Description: Configuration for encryption settings on the Batch Account.
...
object({
    ...
    key_vault_identity = optional(object({
...
### <a name="output_resource_id"></a> resource\_id

Description: The resource ID of the Batch Account.

### <a name="output_name"></a> name

Description: The name of the Batch Account.

### <a name="output_resource"></a> resource

Description: The full resource object of the Batch Account.

### <a name="output_private_endpoints"></a> private\_endpoints
