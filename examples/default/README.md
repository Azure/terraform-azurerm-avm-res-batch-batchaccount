...
module "this" {
  ...
  private_endpoints = {
    endpoint1 = {
      name                       = "${module.naming.batch_account.name_unique}-pe"
...
Description: The Batch Account resource object

### <a name="output_resource_id"></a> [resource_id](#output\_resource\_id)

Description: The Batch Account resource ID

### <a name="output_name"></a> [name](#output\_name)

Description: The Batch Account name

### <a name="output_private_endpoints"></a> [private_endpoints](#output\_private\_endpoints)

Description: The private endpoints created for the Batch Account
